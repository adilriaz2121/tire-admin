      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative flex sm:h-screen  tems-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8">
          <div className="absolute inset-0">
            <img className="object-cover object-center w-full h-full" src="/event.jpg" />
          </div>
        ...
        <div className="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24 sm:h-screen">
          ...
          <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto sm:mt-20">
            <h2 className="text-2xl mt-6  font-bold leading-tight text-black  sm:text-3xl">Login to your account</h2>
            <Formik
                ...
                <Form className="mt-8 space-y-6">
                  ...
                  <div>
                    <button
                      ...
                      className="inline-flex items-center  justify-center w-full px-4 my-7 py-4 text-base font-semibold text-white transition-all duration-200 border border-transparent rounded-xl bg-gradient-to-r from-[#FF3E55] to-[#DB6E00]  focus:outline-none hover:opacity-80 focus:opacity-80"
                    >
                      {loading ?
                        <>
                          <div role="status">
